...
# WReN
CUDA_VISIBLE_DEVICES=$gpus python main_bongard.py --config-name wren_scratch_wocap
CUDA_VISIBLE_DEVICES=$gpus python main_bongard.py --config-name wren_in1k_wocap

# Meta-Baseline
CUDA_VISIBLE_DEVICES=$gpus python main_bongard.py --config-name metabaseline_scratch_wocap
CUDA_VISIBLE_DEVICES=$gpus python main_bongard.py --config-name metabaseline_in1k_wocap
